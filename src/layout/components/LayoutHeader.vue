<template>
    <a-layout-header>
        <div class="bg-zinc-800 border-b border-b-slate-200 flex justify-between items-center p-1.5 px-4 text-slate-100"
            ...
            <div class="user-profile">
                <a-space :size="15">
                    <a-button size="mini" @click="outCodeDrawerRef.handleClick()">出码</a-button>
                    <a-avatar :size="24">
                        <img
                            alt="avatar"
